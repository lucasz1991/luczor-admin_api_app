...
<?php $component->withAttributes([]); ?>
    ...
    <form class="mt-6 space-y-4" method="POST" action="<?php echo e(route('register')); ?>">
        ...
        <div>
            ...
            <input class="luczor-input" id="name" name="name" type="text" value="<?php echo e(old('name')); ?>" required autofocus autocomplete="name">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div>
            ...
            <input class="luczor-input" id="email" name="email" type="email" value="<?php echo e(old('email')); ?>" required autocomplete="username">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <p class="text-center text-sm text-slate-400">
            Schon registriert?
            <a class="text-cyan-200 hover:text-cyan-100" href="<?php echo e(route('login')); ?>">Einloggen</a>
        </p>
    </form>
...
<?php endif; ?>
<?php /**PATH E:\projekte\luczor\admin_api_app\resources\views/auth/register.blade.php ENDPATH**/ ?>