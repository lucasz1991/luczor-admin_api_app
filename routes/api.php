...
Route::prefix('v1')->group(function () {
    Route::post('/auth/device', [DevicePairingController::class, 'store'])->middleware('throttle:10,1');
    Route::post('/auth/device/{id}/claim', [DevicePairingController::class, 'claim'])->middleware('throttle:30,1')->whereUuid('id');
    Route::post('/auth/device/logout', [DevicePairingController::class, 'logout'])
        ->middleware(['luczor.api:settings.read', 'throttle:10,1'])->name('api.v1.auth.device.logout');
    ...
    Route::post('/tasks/verify-create', [TaskController::class, 'verifyCreate'])
        ->middleware('luczor.api:brain.write')->name('api.v1.tasks.verify-create');
    ...
    Route::post('/conversations/verify-create', [ConversationController::class, 'verifyCreate'])
        ->middleware('luczor.api:brain.write')->name('api.v1.conversations.verify-create');
